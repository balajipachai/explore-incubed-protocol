...
1. Written a test application to investigate or list or visualize the information of the Registry contract or interact therewith (for instance list of nodes, security deposit, try to convict a node, ...)
